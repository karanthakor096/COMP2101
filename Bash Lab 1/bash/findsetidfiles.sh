...
find / -type f -executable ls -lh --block-size=MB {} + 2>/dev/null | sort -k5 -hr | head -n 12 | awk '{print $3, $5, $9}'
echo "files with their titel"
find / -type f -executable -perm -2000 -ls 2>/dev/null | sort -k 5 | head -n 12 | awk '{print $3,$5,$6,$11}'
# for the task, add
